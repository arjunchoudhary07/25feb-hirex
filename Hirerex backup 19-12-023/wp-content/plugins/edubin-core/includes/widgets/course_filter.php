...
class Edubin_Elementor_Widget_Course_Filter extends Widget_Base {
    ...
    public function get_keywords() {
        return [ 'Course Filter', 'lp course filter', 'learnpress course filter' , 'filter search', 'filter course' ];
    }
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} edubin-course .course__media img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
            ...
            <div class="edubin-lp-course-wrapper-<?php echo esc_attr($settings['course_style']); ?>">
                ...
                <div id="edubindiv1" class="row">
                    <?php
                     ...
                     ?>
                    <?php require EDUBIN_ADDONS_PL_PATH . 'includes/widgets/templates/lp_filter_grid.php'; ?>
              ...
              <div id="edubindiv2" class="row" style="display:none;">
                    <?php
                        ...
                        while( $query->have_posts() ): $query->the_post();
                            ...
                            $count =  (int)learn_press_get_course()->count_students();
                     ?>
                    <?php require EDUBIN_ADDONS_PL_PATH . 'includes/widgets/templates/lp_filter_list.php'; ?>
                    <?php endwhile; wp_reset_postdata(); wp_reset_query(); ?>
                    <?php endif; ?>
              </div>
