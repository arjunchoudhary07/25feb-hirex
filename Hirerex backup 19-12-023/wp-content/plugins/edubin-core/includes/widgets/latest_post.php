...
$this->add_group_control(
    ...
    [
        ...
        'selector' => '{{WRAPPER}} .edubin-latest-news.layout-1 .single-news .news-cont ul li a, .edubin-latest-news.layout-5 .single-news .news-cont ul li a, .edubin-latest-news .edubin-news-meta ul li a, .edubin-latest-news .edubin-blog-date p span',
    ]
);
$this->add_group_control(
    Group_Control_Typography::get_type(),
...
protected function render( $instance = [] ) {
    ...
    <?php if ($settings['layout_style'] == '1' || $settings['layout_style'] == '5' || $settings['layout_style'] == '6') : ?>
        <div class="row edubin-latest-news layout-<?php echo esc_attr($settings['layout_style']);?>">
            ...
            if($query->have_posts()): 
                while($query->have_posts()): 
                    ...
                    <div class="<?php if( $settings['layout_style'] == '6') : echo 'edubin-no-gutters'; endif; ?> col-lg-<?php if( $settings['layout_style'] == '1' || $settings['layout_style'] == '5' || $settings['layout_style'] == '6') : echo $clm_layout_2; else : echo $column_layout_left; endif; ?> ">
