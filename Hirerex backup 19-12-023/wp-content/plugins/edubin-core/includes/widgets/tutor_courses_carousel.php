...
class Edubin_Elementor_Widget_Tutor_Course_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __('Courses (Tutor)', 'edubin-core');
	}
    public function get_keywords() {
        return [ 'tutor', 'tutor course', 'courses', 'tutor lms'];
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'show_duration_text_list_item',
            [
                'label' => esc_html__( 'Duration Text List Item', 'edubin-core' ),
                'type' => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'default' => 'yes',
            ]
	...
	protected function render($instance = []) {
		...
		<?php if ($settings['carousel_on_off'] == 'yes'): ?>
 		...
 		<?php else : ?>
			<div class="row layout__<?php echo esc_attr($settings['course_style']); ?>">
		<?php endif;?>
