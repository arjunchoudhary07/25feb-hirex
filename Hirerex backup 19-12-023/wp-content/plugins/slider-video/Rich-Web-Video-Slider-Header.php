...
<div class='Rich_Web_Header_Main'>
	...
	<div class="Rich_Web_Header_Free_Version">
		<div class="Rich_Web_Header_Free_Version_Shd">
			<a href="<?php echo esc_url("https://rich-web.org/wp-video-slider/"); ?>" target="_blank" style="text-decoration: none; color: #fff; display: block;">
	...
	<div class="Rich_Web_Header_Contacts">
		<a href="<?php echo esc_url('https://rich-web.org/wp-video-slider-content/'); ?>" target="_blank">Demo</a>
		<a href="<?php echo esc_url('https://wordpress.org/plugins/slider-video/#faq'); ?>" target="_blank">FAQ</a>
