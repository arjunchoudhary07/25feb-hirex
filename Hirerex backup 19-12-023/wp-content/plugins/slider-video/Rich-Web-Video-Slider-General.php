...
.rw_vs_but_demo,.rw_vs_but_demo:hover,.rw_vs_but_demo:focus,.rw_vs_but_demo:active,
.RW_Support_btn,.RW_Support_btn:hover,.RW_Support_btn:focus,.RW_Support_btn:active { 
...
<form method="POST">
	...
	<div class='Rich_Web_VSlider_Opt_Content_Div_2' >
		<div class='Rich_Web_VSlider_Opt_Table_Data'>
			...
			?>
			<div id="Rich_Web_VS_Opt_Content_<?php echo esc_html($Rich_WebSliderCount[$i]->id) ;?>" class="Rich_Web_VS_Opt_Content  <?php echo in_array($Rich_WebSliderCount[$i]->slider_Vid_type,$RW_VS_All_FR) ? 'free' : 'pro' ; ?>">
					<img src="<?php echo esc_url(plugins_url("/Images/WordPress-Video-Slider-".esc_html($RW_VS_Opt_Type).'.png',__FILE__));?>" alt="<?php echo esc_html($Rich_WebSliderCount[$i]->slider_vid_name); ?>" class="Rich_Web_VS_Image">
					<div class="Rich_Web_VS_All_Icons">
						<h4 class="Rich_Web_VS_Name"><?php echo esc_html($Rich_WebSliderCount[$i]->slider_vid_name);?></h4>
						<div class="Rich_Web_VS_Icon_Opt" id="Rich_Web_VS_Icon_Opt_<?php echo esc_html($Rich_WebSliderCount[$i]->id) ;?>">
                   			<div class="Rich_Web_VS_Icon" onclick="Rich_Web_VSlider_Edit_Option(<?php echo esc_html($Rich_WebSliderCount[$i]->id) ;?>)">
                   			    <i class="Rich_Web_VS_Edit rich_web rich_web-pencil"></i>
                   			</div>    
                   			<div class="Rich_Web_VS_Icon" onclick="Rich_Web_VSlider_Copy_Option(<?php echo esc_html($Rich_WebSliderCount[$i]->id) ;?>)">
                   			    <i class="Rich_Web_VS_Copy rich_web rich_web-files-o"></i>
                   			</div>    
							<div class="Rich_Web_VS_Icon" onclick="Rich_Web_VSlider_Del_Option(<?php echo esc_html($Rich_WebSliderCount[$i]->id) ;?>)">
			...
			for($i=0;$i<count($RW_VS_All_N_Ins);$i++){
				...
				<div id="Rich_Web_VS_Opt_Content_<?php echo esc_html($RW_VS_Opt_Type) ;?>" class="Rich_Web_VS_Opt_Content  <?php echo in_array($RW_VS_All_N_Ins[$i],$RW_VS_All_FR) ? esc_html('free') : esc_html('pro') ; ?>" >
					<img src="<?php echo esc_url(plugins_url("/Images/WordPress-Video-Slider-".esc_html($RW_VS_Opt_Type).'.png',__FILE__));?>"  alt="<?php echo esc_attr($RW_VS_All_N_Ins[$i]); ?>" class="Rich_Web_VS_Image">
					...
					<?php endif;?>
					<div class="Rich_Web_VS_All_Icons">
						<h4 class="Rich_Web_VS_Name"><?php echo esc_html($RW_VS_All_N_Ins[$i]); ?></h4>
						<div class="Rich_Web_VS_Icon_Opt" id="Rich_Web_VS_Icon_Opt_<?php echo esc_html($RW_VS_Opt_Type) ;?>">
						<?php if (in_array($RW_VS_All_N_Ins[$i],$RW_VS_All_FR)) : ?>
							<a class="rw_vs_but_demo"  href="<?php  echo esc_url($RW_VS_All_T_Links[$RW_VS_Opt_Type]); ?>" target="_blank">
								<i class="Rich_Web_VS_Demo rich_web rich_web-eye"></i>
							</a> 
                            <button class="rw_vs_but_install" onclick="Rich_Web_VS_Insert('<?php echo esc_html($RW_VS_Opt_Type) ;?>')">
								<i class="Rich_Web_VS_Install rich_web rich_web-cloud-download"></i>
							 	Insert
							</button> 
						<?php else: ?>
							<a class="rw_vs_but_demo"
							href="<?php  echo esc_url($RW_VS_All_T_Links[$RW_VS_Opt_Type]); ?>" target="_blank">
				...
				<tr>
					...
					<td>
						...
						<?php for ($t=0; $t < count($RW_VS_All_T); $t++) { ?>
							<option value="<?php echo esc_html($RW_VS_All_T[$t]); ?>"><?php echo esc_html($RW_VS_All_T[$t]); ?></option>
							<?php } ?></select>
					</td>
				</tr>
			</table>
					...
					<td>
						<select class="Rich_Web_VSlider_Select_Menu" id="Rich_Web_VS_CP_TFF" name="Rich_Web_VS_CP_TFF">
							<?php for($i=0;$i<count($Rich_Web_VSlider_Fonts);$i++){ ?>
								<option value="<?php echo esc_html($Rich_Web_VSlider_Fonts[$i]->Font_family);?>"><?php echo esc_html($Rich_Web_VSlider_Fonts[$i]->Font_family);?></option>
							<?php }?>
						</select>
					</td>
					<td>
