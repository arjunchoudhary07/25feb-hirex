...
(function() {
  ...
  document.querySelector(".chat-button").addEventListener("click", function() {
	...
	(function() {
  function onTidioChatApiReadyone() {
    window.tidioChatApi.hide();
  }

  if (window.tidioChatApi) {
    window.tidioChatApi.on("ready", onTidioChatApiReadyone);
  }

  document.querySelector(".chat-button2").addEventListener("click", function() {
    window.tidioChatApi.show();
    window.tidioChatApi.open();
  });
})();
	(function() {
  function onTidioChatApiReadytwo() {
    window.tidioChatApi.hide();
  }

  if (window.tidioChatApi) {
    window.tidioChatApi.on("ready", onTidioChatApiReadytwo);
  }

  document.querySelector(".chat-button3").addEventListener("click", function() {
    window.tidioChatApi.show();
    window.tidioChatApi.open();
  });
})();
